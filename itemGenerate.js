...
async function processPreferences(preferences) {
  if (!preferences) {
    throw new Error("Preferences object is undefined or null");
  }
  ...
  console.log('Processed Preferences JSON:', jsonString);
  return results;
}

// Execute the processPreferences function with the provided preferences
processPreferences(preferences).then((result) => {
  console.log('Final Result:', result);
}).catch((error) => {
  console.error('Error processing preferences:', error);
});

// export { processPreferences, itemList };
...
// // Define your list of items and input string
// const itemsList = {
